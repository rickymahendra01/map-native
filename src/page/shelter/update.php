<?php
    ...
    $arrFieldUnit = ["jenis","kode","longitude","latitude","keterangan"];
    $arrDataUnit = ["shelter",$request->get('kode'),$request->get('longitude'),$request->get('latitude'),$request->get('keterangan')];
