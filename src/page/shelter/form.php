<?php
    ...
    $r = $control->model->getListQuery("SELECT kode FROM waypoint WHERE (jenis='shelter') ORDER BY id DESC LIMIT 0,1",['kode']);
    ...
    $content =  $control->view->getFormName("form".$dir,
                    ...
                    $control->view->getDivInput("Nama Shelter", 
                                                $control->view->getFormInputTextArea("keterangan", "", "4", "", "")).
